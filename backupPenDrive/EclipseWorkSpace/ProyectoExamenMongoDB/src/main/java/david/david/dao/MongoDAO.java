...
import david.david.connection.MongoConnection;

public class MongoDAO {
	
	MongoConnection mongoConnection;
	
	public MongoDAO(String db, String coll){
	...
	public FindIterable<Document> consultarDocumentos() {
		return mongoConnection.getColleccion().find();
	}
