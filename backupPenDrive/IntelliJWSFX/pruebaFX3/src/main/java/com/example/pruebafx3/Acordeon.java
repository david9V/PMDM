...
public class Acordeon extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image logo1 = new Image("file:resources/images/mustangGT2022.png", 200, 200, true, true);
            Image logo2 = new Image("file:resources/images/beer_emoji.png", 200, 200, true, true);
