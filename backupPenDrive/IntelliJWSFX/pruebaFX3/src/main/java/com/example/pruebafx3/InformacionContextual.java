...
public class InformacionContextual extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image imgCerveza = new Image("file:resources/images/beer_emoji.png", 50, 50, true, true);
            ...
            Image imgApagar = new Image("file:resources/images/shutdown_emoji.png", 50, 50, true, true);
